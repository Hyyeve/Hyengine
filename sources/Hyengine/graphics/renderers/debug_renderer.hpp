...
namespace hyengine::graphics {
    ...
    public:
        ...
        debug_renderer(const debug_renderer& other) = delete; //COPY CONSTRUCTOR
        debug_renderer(debug_renderer&& other) = delete; //MOVE CONSTRUCTOR
        debug_renderer& operator=(const debug_renderer& other) = delete; //COPY ASSIGNMENT
        debug_renderer& operator=(debug_renderer&& other) noexcept = delete; //MOVE ASSIGNMENT
