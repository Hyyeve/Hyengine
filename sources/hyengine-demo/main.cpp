...
int main()
{
    ...
    std::string ansi_code = hyengine::ansi_codes::ansi_rgb(127, 127, 255);
    hyengine::log(hyengine::logger_tags::DEBUG, hyengine::stringify("RGB ?", ansi_code, " meow"), "DEBG", hyengine::ansi_codes::ANSI_CYAN);
    ...
    const bool did_allocate_renderer = renderer.allocate(1);
